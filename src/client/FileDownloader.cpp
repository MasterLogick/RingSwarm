...
KeyHandler *createKeyHandler(core::Id *keyId) {
    ...
    if (keySwarm != nullptr) {
        BOOST_LOG_TRIVIAL(debug) << "File download: Local cache hit for "
                                 << keyId->getHexRepresentation();
