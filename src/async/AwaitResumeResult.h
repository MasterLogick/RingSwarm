...
public:
    explicit AwaitResumeResultBase(std::exception_ptr exceptionPtr)
        : exceptionPtr(std::move(exceptionPtr)) {}

    AwaitResumeResultBase(const AwaitResumeResultBase<
                          Coroutine<AwaitedRetTypes...>,
                          RetTypes...> &) = delete;

    AwaitResumeResultBase(AwaitResumeResultBase<
                          Coroutine<AwaitedRetTypes...>,
                          RetTypes...> &&) = delete;
    ...
    ~AwaitResumeResultBase() {
        Assert(
            touched,
            "co_await return value must be touched before destruction"
        );
    }
};
...
template<typename... AwaitedRetTypes, typename... RetTypes>
class AwaitResumeResult<Coroutine<AwaitedRetTypes...>, RetTypes...>
    : public AwaitResumeResultBase<Coroutine<AwaitedRetTypes...>, RetTypes...> {
    std::tuple<AwaitedRetTypes...> retValues;

public:
    explicit AwaitResumeResult(
        std::tuple<AwaitedRetTypes...> retValues,
        std::exception_ptr exceptionPtr
    )
        : AwaitResumeResultBase<Coroutine<AwaitedRetTypes...>, RetTypes...>(
              std::move(exceptionPtr)
          ),
          retValues(std::move(retValues)) {}
...
class AwaitResumeResult<Coroutine<AwaitedRetType>, RetTypes...>
    : public AwaitResumeResultBase<Coroutine<AwaitedRetType>, RetTypes...> {
...
public:
    explicit AwaitResumeResult(
        ...
        : AwaitResumeResultBase<Coroutine<AwaitedRetType>, RetTypes...>(
              std::move(exceptionPtr)
          ),
...
class AwaitResumeResult<Coroutine<>, RetTypes...>
    : public AwaitResumeResultBase<Coroutine<>, RetTypes...> {
public:
...
template<typename... AwaitedRetTypes, typename... RetTypes>
struct std::tuple_size<RingSwarm::async::AwaitResumeResult<
    RingSwarm::async::Coroutine<AwaitedRetTypes...>,
    RetTypes...>> : public std::tuple_size<std::tuple<AwaitedRetTypes...>> {};

template<std::size_t I, typename... AwaitedRetTypes, typename... RetTypes>
struct std::tuple_element<
    I,
    RingSwarm::async::AwaitResumeResult<
        RingSwarm::async::Coroutine<AwaitedRetTypes...>,
        RetTypes...>> {
